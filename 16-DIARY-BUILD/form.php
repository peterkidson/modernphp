...
<body>
    ...
    <footer class="footer">
        <div class="container">
            <h3 class="footer__heading">PHP Diary</h3>
            <p class="footer__desc">
                FORM.php How to use FAQs Using My Account How to...
                Help searching the catalogue
                Useful links
                Find a Library Price List  Volunteering Community Information SELMS Consortium
            </p>
        </div>
    </footer>
